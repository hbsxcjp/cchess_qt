#############################################################################
# Makefile for building: cchess
# Generated by qmake (3.1) (Qt 5.14.2)
# Project:  cchess.pro
# Template: app
# Command: C:\Qt\Qt5.14.2\5.14.2\mingw73_64\bin\qmake.exe -o Makefile cchess.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
ZIP           = zip -r -9
DEF_FILE      = 
RES_FILE      = cchess_resource_res.o
...
Makefile: cchess.pro C:/Qt/Qt5.14.2/5.14.2/mingw73_64/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.14.2/5.14.2/mingw73_64/mkspecs/features/spec_pre.prf \
		...
		res.qrc
	$(QMAKE) -o Makefile cchess.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
